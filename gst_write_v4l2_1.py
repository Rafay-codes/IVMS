    ...
    def __init__(self, opt):
        ...
        try:
            ...
            for i in range(1, int(opt.parts) + 1):
                ...
                pipeline_str = f"nvv4l2camerasrc device=/dev/video1 ! nvvidconv ! nvv4l2h265enc ! h265parse ! matroskamux ! filesink location={full_path}.mkv"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--folder', type=str, default='/home/nvidia/ivms/recordings/1', help='output folder')    
