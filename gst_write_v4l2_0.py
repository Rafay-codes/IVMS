...
class RTSPVideoWriter(object):
    def __init__(self, opt):
        ...
        try:
            ...
            for i in range(1, int(opt.parts) + 1):
                ...
                #v4l2src device=/dev/video0 ! nvvidconv ! 'video/x-raw(memory:NVMM), format=(string)I420_10LE' ! omxh265enc ! matroskamux ! filesink location=test_10bit.mkv -e
                pipeline_str = f"nvv4l2camerasrc device=/dev/video0 ! nvvidconv ! nvv4l2h265enc ! h265parse ! matroskamux ! filesink location={full_path}.mkv"

                #gst-launch-1.0 v4l2src device=/dev/video0 ! nvv4l2decoder ! nvvideoconvert ! x264enc !
                # DEBUG ONLY
    ...
    def configure_logging(self):
        ...
        log_base_dir = '/srv/ivms/detect'     
        log_fname = 'write_rtsp0.log'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ip', type=str, default='192.168.100.101:8554', help='camera ip address')    
    ...
    parser.add_argument('--folder', type=str, default='/home/nvidia/ivms/recordings/0', help='output folder')      
