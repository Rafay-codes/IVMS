...
if __name__ == '__main__':
    ...
    parser.add_argument('--ip', type=str, default='192.168.100.102:8554', help='camera ip address')    
    ...
    parser.add_argument('--folder', type=str, default='/srv/ivms_v2/recordings/1', help='output folder')      
